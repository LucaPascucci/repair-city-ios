...
//  Modified by InfinityCode on 06/08/15.
...
public class SCLAlertView: UIViewController {
    ...
    public func showCustomSuccess(title: String, subTitle: String , colorStyle: UInt=0x22B573, colorTextButton: UInt=0xFFFFFF) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: 0.0, completeText:nil, style: .Success, colorStyle: colorStyle, colorTextButton: colorTextButton)
    }
